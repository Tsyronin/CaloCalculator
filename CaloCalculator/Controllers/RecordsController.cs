...
namespace CaloCalculator.Controllers
{
    ...
    public class RecordsController : ControllerBase
    {
        ...
        public RecordsController(CaloCalculatorContext context)
        {
            _context = context;
        }
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<ActionResult<Record>> PostRecord(RecordViewModel recordVM)
        {
            if ((!_context.Dishes.Any(d => d.Id == recordVM.DishId)) ||
                recordVM.Grams <= 0)
            {
                return BadRequest();
            }
            ...
            {
                DishId = recordVM.DishId,
                Grams = recordVM.Grams,
